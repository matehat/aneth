(function() {
  ...
  Server = (function() {
    ...
    Server.prototype.createAdvertisement = function() {
      ...
      try {
        console.log(service, parseInt(port), hostname);
    ...
    Server.prototype.updateHosts = function() {
      var a, file, h, hostname, ip, prior, stream, tail, _i, _j, _len, _len1, _ref, _ref1, _ref2;
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        hostname = _ref[_i];
        if (!((ip = this.members[hostname]) != null)) {
          continue;
        }
        stream += "" + ip + " " + hostname + "\n";
        ...
        for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
          _ref2 = _ref1[_j], h = _ref2[0], a = _ref2[1];
          if (hostname === h) {
            stream += "" + ip + " " + a + "\n";
          }
        }
